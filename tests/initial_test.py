...
from flake8_custom_import_rules import Plugin
...
def test_py310_slicing_of_sys_version_string(s):
    assert results(s) == {
        "2:6: YTT101 `sys.version[:3]` referenced (python3.10), use " "`sys.version_info`",
    }
...
def test_py310_indexing_of_sys_version_string(s):
    assert results(s) == {
        "2:11: YTT102 `sys.version[2]` referenced (python3.10), use " "`sys.version_info`",
    }
...
def test_py310_string_comparison(s):
    assert results(s) == {
        "2:0: YTT103 `sys.version` compared to string (python3.10), use " "`sys.version_info`",
    }
...
def test_py310_string_comparison_of_1_char(s):
    assert results(s) == {
        "2:0: YTT302 `sys.version` compared to string (python10), use " "`sys.version_info`",
    }
...
def test_py10_indexing_of_sys_version_string(s):
    assert results(s) == {
        "2:11: YTT301 `sys.version[0]` referenced (python10), use " "`sys.version_info`",
    }
...
def test_py10_slicing_of_sys_version_string(s):
    assert results(s) == {
        "2:6: YTT303 `sys.version[:1]` referenced (python10), use " "`sys.version_info`",
    }
